...
class TestBinaryChoiceCandidates(unittest.TestCase):
    ...
    def test_find_choice_candidates_in_dfg(self):
        ...
        found_choices = find_binary_choice_candidates_in_dfg(dfg)

        expected_choices = set([
            Choice([Singleton('1'), Singleton('4')]),
            Choice([Singleton('2'), Singleton('3')]),
            Choice([Singleton('2'), Singleton('5')]),
            Choice([Singleton('3'), Singleton('5')]),
