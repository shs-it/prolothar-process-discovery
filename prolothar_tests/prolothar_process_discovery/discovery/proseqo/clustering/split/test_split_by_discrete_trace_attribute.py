...
import unittest
from prolothar_process_discovery.discovery.proseqo.clustering.split.split_by_discrete_trace_attribute import SplitByDiscreteTraceAttribute
...
class TestSplitByDiscreteTraceAttribute(unittest.TestCase):
    ...
    def test_split(self):
        ...
        clusters = SplitByDiscreteTraceAttribute('DayInWeek').split(log)
