...
import unittest
from prolothar_process_discovery.discovery.proseqo.clustering.similarity.levenshtein_similarity import LevenshteinSimilarity
...
class TestLevenshteinSimilarity(unittest.TestCase):
    ...
    def test_compute_on_two_traces(self):
        ...
        self.assertAlmostEqual(0.69, similarity.compute(log1, log2), delta=0.01)
    ...
    def test_compute_on_logs(self):
        ...
        self.assertAlmostEqual(0.725, similarity.compute(self.log1, self.log2),
                               delta=0.001)
        self.assertAlmostEqual(0.578, similarity.compute(self.log4, self.log5),
                               delta=0.001)
